...
-(void)initTimeLine{
    ...
    self.MNTimeLineCollction = [[UICollectionView alloc] initWithFrame:CGRectMake(0, 100, kWinW, timelineW) collectionViewLayout:flowLayout];
    ...
    self.MNTimeLineCollction.contentOffset =CGPointMake(self.CellWidth * 7 + x - kWinW/2,0);
    self.updateRow = (self.CellWidth * 7 + x) / (int)self.CellWidth;
...
-(void)initTimeLineRedViewAndLabel{
    UIView *redView = [[UIView alloc] initWithFrame:CGRectMake(kWinW/2 - 1, 100, 2, timelineW)];
    redView.backgroundColor = [UIColor redColor];
    [self addSubview:redView];
    redView.tag = 101;
    self.timeLabel = [[UILabel alloc] initWithFrame:CGRectMake(kWinW/2 - 65, 50, 130, 30)];
    self.timeLabel.font = [UIFont systemFontOfSize:12];
    self.timeLabel.backgroundColor = [UIColor colorWithRed:110/255.0f green:205/255.0f blue:245/255.0f alpha:1.0];
